<template>
  <v-navigation-drawer v-model="drawer" app color="#2784ff" mini-variant mini-variant-width="80">
    ...
    <div
      style="position:absolute;bottom:20px;margin-left:auto;margin-right:auto;left:25px;right:0;text-align;center;"
    >
